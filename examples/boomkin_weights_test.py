...
options = DruidOptions(
    ignore_arcane_eclipse=True,
    ignore_nature_eclipse=True,
...
for i in range(num_druids):
    ...
    if i == 0:
        ...
        d.set_arcane_eclipse_subrotation(
            d.moonfire_insect_swarm_starfire_subrotation
        )
        d.set_nature_eclipse_subrotation(
            d.insect_swarm_moonfire_wrath_subrotation
        )
    elif i == 1:
        d = Druid(
            name="1 hit",
