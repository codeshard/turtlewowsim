...
IGNITE_TICK_TIME = 2
IGNITE_NUM_TICKS = (
    IGNITE_WINDOW / IGNITE_TICK_TIME
)  # 2 ticks per ignite window
IGNITE_TICK_AMOUNT_PER_TICK_PER_TALENT_POINT = (
    0.08 / IGNITE_NUM_TICKS
)  # 8% per tick per talent point
...
class Ignite:
    ...
    def _do_dmg(self):
        ...
        tick_dmg *= (
            1 + self.env.debuffs.fire_vuln_stacks * 0.03
