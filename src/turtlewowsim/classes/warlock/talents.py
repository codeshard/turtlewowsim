...
from turtlewowsim.decorators import simtalent
...
class WarlockTalents:
    ...
    voidwalker_master_demonologist: int = (
        0  # 2/4/6/8/10% reduced physical damage taken.
    )
    succubus_master_demonologist: int = (
        0  # 2/4/6/8/10% increased all damage done.
    )
    felhunter_master_demonologist: int = (
        0  # 0.2/0.4/0.6/0.8/1 increased all resistances per level.
    )
